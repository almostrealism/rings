...
import org.almostrealism.audio.transform.LinearResampleTransformer;
import org.almostrealism.audio.transform.ResampleTransformer;

public class MixerMenus {
	public static Hashtable folders;
	
	public static JPopupMenu addSamplePopupMenu;
	public static JavaAudioSample currentSample;
	...
	public static void addBeatBox(String name, final BeatBoxDisplay b) {
		...
		addSampleToBoxMenuItem.addActionListener(new ActionListener () {
			public void actionPerformed(ActionEvent e) {
				JavaAudioSample s = currentSample.shallowCopy();
				s.unloop();
				b.addRow(s);
			}
		});
