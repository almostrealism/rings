 ...
 * Direct (hardware) and DAW (streaming) output modes without recreating
 * the player.
 *
 * <p>This class manages two key concerns:</p>
 * <ul>
 *   <li><b>Active Output Mode</b>: Controlled by the UI widget, determines
 *       which output delegate is currently active</li>
 *   <li><b>DAW Connection State</b>: Managed by AudioLineDelegationHandler,
 *       tracks whether a DAW client has connected</li>
 * </ul>
 *
...
public class UnifiedPlayerConfig implements ConsoleFeatures {
	...
	public enum OutputMode {
		...
		DIRECT,
		/** DAW streaming via SharedMemoryAudioLine */
		DAW
	}
	...
	public boolean isDawMode() {
		return activeMode == OutputMode.DAW;
	}
