...
package com.almostrealism.remote.event.test;

import com.almostrealism.remote.event.DefaultEvent;
import com.almostrealism.remote.event.EventDeliveryQueue;
import com.almostrealism.remote.event.SimpleEventServer;
...
public class EventDeliveryTest {
	...
	public void deliver() throws IOException, InterruptedException {
		...
		EventDeliveryQueue<DefaultEvent> delivery = new EventDeliveryQueue<>("http://localhost:8080/test");
		delivery.start();
