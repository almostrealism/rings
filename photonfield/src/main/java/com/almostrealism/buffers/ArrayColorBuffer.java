...
public class ArrayColorBuffer implements ColorBuffer {
	...
	public void store(Factory<Scene<ShadableSurface>> loader, String name) throws IOException {
...
//								ImageCanvas.RGBListEncoding);
	...
	public void load(Factory<Scene<ShadableSurface>> loader, String name) throws IOException {
//		FileDecoder.readRGBList(loader.getInputStream("-" + name + "-front.rgb"), this.front);  TODO
//		FileDecoder.readRGBList(loader.getInputStream("-" + name + "-back.rgb"), this.back);  TODO
	}
