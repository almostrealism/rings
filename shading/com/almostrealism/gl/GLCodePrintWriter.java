...
public class GLCodePrintWriter extends GLDriver {
	private String glMember, name;
	private CodePrintWriter p;

	public GLCodePrintWriter(String glMember, String name, CodePrintWriter p) {
		super(null);
	...
	public void glColor(double r, double g, double b, double a) {
		if (gl != null) super.glColor(r, g, b, a);

		HashMap args = new HashMap<String, Variable<Double>>();
		args.put("red", new Variable<>("r", r));
		args.put("green", new Variable<>("g", g));
		args.put("blue", new Variable<>("b", b));
		args.put("alpha", new Variable<>("a", a));
	...
	public void glColor4f(float r, float g, float b, float a) {
		if (gl != null) super.glColor4f(r, g, b, a);
